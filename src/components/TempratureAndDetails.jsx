...
const TempratureAndDetails = ({ weather: { details, icon, temp, temp_min, temp_max, sunrise, sunset, speed, humidity, feels_like, timezone } }) => {
        return (
                <div>
                        ...
                        <div className='flex flex-col items-center justify-between text-white py-3 sm:flex-row'>
                                <img
                        ...
                        <div className='flex flex-row items-center justify-center space-x-2 text-white text-sm y-3'>
